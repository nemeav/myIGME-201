    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            {
                linkedList.AddBefore(linkedListNode1, linkedListNode1.Next.Value);
                linkedList.AddAfter(linkedListNode1, linkedListNode1.Previous.Previous.Value);
                linkedList.Remove(linkedList.FindLast("rain"));
                linkedList.Remove("Spain");
                linkedList.AddBefore(linkedListNode2.Previous, linkedListNode2.Next.Value);
                linkedList.AddAfter(linkedListNode2, linkedListNode2.Previous.Previous.Previous.Value);
                linkedList.Remove("plain");
                linkedList.Remove(linkedList.FindLast("mainly"));
            }
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            if (linkedListNode1 != null && linkedListNode2 != null)
            {
                anagram.AddBefore(linkedListNode1.Previous, linkedListNode1.Next.Next.Value);
                anagram.AddAfter(linkedListNode2, linkedListNode1.Previous.Value);
                anagram.Remove(linkedListNode1.Previous);
                anagram.AddLast(linkedListNode1.Next.Value);
                anagram.Remove(linkedListNode1.Next);
                anagram.Remove(linkedListNode1.Next);
                anagram.AddAfter(linkedListNode1.Next, linkedListNode2.Next.Next.Next.Value);
                anagram.Remove(anagram.FindLast("Y"));
                anagram.AddBefore(linkedListNode2, linkedListNode2.Next.Next.Value);
                anagram.Remove(anagram.FindLast("R"));
            }
