 ...
 * Purpose: Edit starter code to make math quiz include division that rounds to 2 decimal places
 * Restrictions: none
 */
class Program
{
    /* Purpose: edit to include division operation with rounding, replace ints with doubles
     * Restrictions: none
     * returns: feedback on answers once user inputs them?
     */
    static void Main()
    {
        // store user name
        ...
        //change values given in questions to doubles
        double val1 = 0;
        double val2 = 0;
        double nAnswer = 0;
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            //if operator for question is division, round accepted answer to 2 places
            if (nOp == 3 )
            {
