...
namespace JsonHtml
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            StreamWriter writer = new StreamWriter("C:/Users/nemea/Downloads/students.json"); //("c:/temp/students.json");
            writer.Write(s);
            writer.Close();

            writer = new StreamWriter("C:/Users/nemea/Downloads/teachers.json"); //("c:/temp/teachers.json");
            writer.Write(t);
            writer.Close();

            StreamReader reader = new StreamReader("C:/Users/nemea/Downloads/students.json");
            s = reader.ReadToEnd();
            reader.Close();

            reader = new StreamReader("C:/Users/nemea/Downloads/teachers.json");
            t = reader.ReadToEnd();
            reader.Close();
