...
static class Program
{
    ...
    //timer and boolean to handle it
    ...
    static void Main()
    {
        ...
        //new timer instance + elapsed event
        endTimer = new Timer(5000);
        endTimer.Elapsed += new ElapsedEventHandler(EndQuestion);
    ...
    static void EndQuestion(object sender, ElapsedEventArgs e)
    {
        Console.WriteLine();

        Console.WriteLine("Oh no! Times up :(");
